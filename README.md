...
- [Working with agents](./docs/guide/agents.md) — [agents](./docs/guide/agents.md) · [the sidebar](./docs/guide/sidebar.md) · [spending](./docs/guide/spending.md) · [remote](./docs/guide/remote.md) · [web](./docs/guide/web.md)
