...
- **Know Your Pace:** $ token insight for today, week, and month, with every provider's plan and 5h/7d budget bars draining in real time; one look tells you where the week is going, and `rimz loop` can start a provider's window on a schedule so it resets before you sit down
