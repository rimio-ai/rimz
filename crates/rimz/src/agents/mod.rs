...
pub use login::{
    LoginCatalog, LoginConfigErr, LoginErr, LoginMismatch, ProviderLogin, RoomLoginErr,
    ambient_env, default_named_home, room_login,
};
...
pub use state::{
    ...
    PendingWaitTrigger, is_stalled, is_tool_looping, is_turn_dead, settled_outcome,
...
pub enum PresetArgMatcher {
    ...
    Flag(Vec<String>),
    /// A single-use named flag whose value is prompt text rather than a path.
    TextFlag(Vec<String>),
