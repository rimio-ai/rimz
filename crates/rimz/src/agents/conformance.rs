...
"#,
    ...
    amp.Effort=Err(UnsupportedField { agent: "amp", field: "effort" })
    amp.AutoCompact=Err(UnsupportedField { agent: "amp", field: "auto-compact" })
    amp.empty-Model=Ok([])
    amp.empty-Effort=Ok([])
    amp.empty-AutoCompact=Ok([])
    amp.all=Err(UnsupportedField { agent: "amp", field: "effort" })
    ...
    antigravity.Effort=Ok(["--effort", "high"])
    ...
    antigravity.all=Ok(["--model", "model-x", "--effort", "high"])
