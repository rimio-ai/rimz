...
const COPILOT_COVERAGE: CoverageAnnotations = CoverageAnnotations {
...
const COPILOT_LIFECYCLE_HOOKS: LifecycleAnnotations = LifecycleAnnotations {
...
impl crate::agents::capabilities::InstallationCapability for CopilotAdapter {
...
impl crate::agents::capabilities::TranscriptCapability for CopilotAdapter {
    fn parse_transcript_messages(&self, lines: &str) -> Vec<TranscriptMessage> {
        transcript::parse_messages(lines)
    }
}

impl crate::agents::capabilities::ContextCapability for CopilotAdapter {
