...
//! ([`crate::agents::adapters::codex::broker`]) over its unix socket — a held, already
...
//! [`crate::agents::adapters::codex`]; this client supplies what the app-server *does* expose
