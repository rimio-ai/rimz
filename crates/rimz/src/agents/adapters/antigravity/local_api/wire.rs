...
pub(in crate::agents::adapters::antigravity) fn parse_identity(
    body: &str,
...
pub(in crate::agents::adapters::antigravity) fn parse_account_usage_identity(
    body: &str,
...
pub(in crate::agents::adapters::antigravity) fn account_key(email: &str) -> Option<String> {
...
pub(in crate::agents::adapters::antigravity) fn parse_rate_limits(
    body: &str,
