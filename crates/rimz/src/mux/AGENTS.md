...
Local contract for `crates/rimz/src/mux/` — the Zellij/tmux seam. Extends [crates/rimz/AGENTS.md](../../AGENTS.md); it never restates parent rules. Backend behaviour — selection, session birth, layouts, focus, recovery — lives in [docs/internals/mux/multiplexers.md](../../../../docs/internals/mux/multiplexers.md).
