...
- Feature work lands on both backends in the same change. A backend-only channel — the tmux control-mode presence watch, the dormant Zellij pipe — is a latency hint layered over the poll/socket truth.
