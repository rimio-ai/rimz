...
use crate::sidebar_renderer::render::TallyAnim;
use crate::sidebar_renderer::render::fmt::{dollars2, tokens_int};
use crate::sidebar_renderer::render::labels::token_breakdown_spans;
...
/// ([`cockpit_spend_line`]).
pub(in crate::sidebar_renderer::render) fn cockpit_summary_line(
    theme: &Theme,
    sessions: u32,
...
pub(in crate::sidebar_renderer::render) fn cockpit_spend_line(
    theme: &Theme,
    live_agents: usize,
    today_usd: f64,
    anim: &TallyAnim,
