...
use crate::sidebar_renderer::render::fmt::age_secs;
use crate::sidebar_renderer::render::labels::{age_heat, agent_style, status_glyph, status_style};
use crate::sidebar_renderer::render::theme::{ORANGE, Theme};
...
pub(in crate::sidebar_renderer::render) fn fleet_header_lines(
    theme: &Theme,
...
pub(in crate::sidebar_renderer::render) fn fleet_size(
    groups: &[SidebarWorktreeGroup],
) -> (usize, usize) {
    let main = groups
        .iter()
...
/// aggregate echo of
/// [`attention_glyph_style`](crate::sidebar_renderer::render::labels::attention_glyph_style)'s
...
pub(in crate::sidebar_renderer::render) fn first_run_hint_lines(
    theme: &Theme,
    hooks_ready: bool,
) -> Vec<Line<'static>> {
    let dim = theme.dim();
