...
mod tests {
    ...
    fn reload_control_word_decodes_to_reload() {
        ...
        assert_eq!(
            decode_wakeup(crate::ledger::wakeup::RELOAD_WAKEUP),
            Wakeup::Reload
        );
    }
    ...
    fn pane_frame_published_control_word_decodes_to_publication() {
        ...
        assert_eq!(
            decode_wakeup(crate::ledger::wakeup::PANE_FRAME_PUBLISHED_WAKEUP),
            Wakeup::PaneFramePublished
        );
    }
    ...
    fn control_words_never_start_with_brace() {
        ...
        let mut words = vec![
            ...
            String::from_utf8(crate::ledger::wakeup::RELOAD_WAKEUP.to_vec()).unwrap(),
            String::from_utf8(crate::ledger::wakeup::PANE_FRAME_PUBLISHED_WAKEUP.to_vec()).unwrap(),
        ];
        for code in [
            KeyCode::Up,
            KeyCode::Down,
