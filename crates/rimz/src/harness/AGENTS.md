...
- The harness owns layout specs, launch argv, stable handles, supervised run records, the run-wake socket (`run_wake.rs`), rebirth inspection and materialization, resume planning, loop scheduling, hidden runner domain, and auto-continue policy.
