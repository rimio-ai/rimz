...
Topic detail lives in [harness.md](../../../../docs/internals/agents/harness.md), with the shared delivery substrate in [message.md](../../../../docs/internals/agents/message.md).

## Boundaries

- The harness owns layout specs, launch argv, stable handles, supervised run records, resume-on-rebirth planning, loop scheduling, hidden runner domain, and auto-continue policy.
