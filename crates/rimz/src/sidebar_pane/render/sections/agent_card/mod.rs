...
use crate::sidebar_pane::render::labels::{
    ...
    severity_heat_amount, severity_heat_color, status_glyph, subagent_head_style,
    token_breakdown_spans, token_total_glyph, unread_run_spans, window_style, working_style,
};
