...
/// inherits a DSN. With no `dsn` set, Sentry stays off and Rimz makes no
/// network calls; the [`crate::observability`] module reads this section (and
/// the `RIMZ_SENTRY_DSN` / `RIMZ_SENTRY_ENVIRONMENT` overrides) at startup.
