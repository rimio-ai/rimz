...
impl SidebarSnapshot {
    ...
    /// order (`claude, codex, copilot, gemini, pi, opencode, kiro`) — the panels are the dashboard's
...
/// in [`known_kinds`](crate::agents::known_kinds) (`claude, codex, copilot, gemini, pi, opencode, kiro`),
