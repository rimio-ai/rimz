...
impl SidebarSnapshot {
    ...
    /// order (`claude, codex, amp, copilot, gemini, pi, opencode, kiro, qwen`) — the panels are the dashboard's
...
/// in [`known_kinds`](crate::agents::known_kinds) (`claude, codex, amp, copilot, gemini, pi, opencode, kiro, qwen`),
