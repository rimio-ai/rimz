...
use rimz::store::snapshot::{
    ...
    SidebarWorktreeKind, SubAgentTokens, WorktreeCi, WorktreePrState, WorktreeTrunkSync,
};
            ...
            sub_agents: Some(vec![
                sub_agent(
                    SubAgentSpec {
                        ...
                        description: None,
                        tokens: Some(SubAgentTokens::Total(23_500)),
                        cost_usd: None,
                ...
                sub_agent(
                    SubAgentSpec {
                        ...
                        model: Some("Sonnet 4.6"),
                        description: None,
                        tokens: Some(SubAgentTokens::Window(14_800)),
                        cost_usd: None,
            ...
            sub_agents: Some(vec![
                sub_agent(
                    SubAgentSpec {
                        ...
                        tokens: Some(SubAgentTokens::Window(20_100)),
                        cost_usd: Some(0.34),
                ...
                sub_agent(
                    SubAgentSpec {
                        ...
                        tokens: Some(SubAgentTokens::Window(18_700)),
                        cost_usd: Some(0.27),
                ...
                sub_agent(
                    SubAgentSpec {
                        ...
                        model: Some("Haiku"),
                        description: None,
                        tokens: Some(SubAgentTokens::Window(11_400)),
                        cost_usd: Some(0.18),
                ...
                sub_agent(
                    SubAgentSpec {
                        ...
                        tokens: Some(SubAgentTokens::Window(9_900)),
                        cost_usd: Some(0.14),
                ...
                sub_agent(
                    SubAgentSpec {
                        ...
                        tokens: Some(SubAgentTokens::Window(8_700)),
                        cost_usd: Some(0.12),
    ...
    let mut children = vec![
        sub_agent(
            SubAgentSpec {
                ...
                tokens: Some(SubAgentTokens::Total(22_400)),
        ...
        sub_agent(
            SubAgentSpec {
                ...
                model: Some("Haiku"),
                description: None,
                tokens: Some(SubAgentTokens::Window(18_900)),
