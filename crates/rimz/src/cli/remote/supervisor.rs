...
fn prepare_control_path(path: &Path) -> Result<()> {
    ...
    rimz::disk::paths::ensure_private_runtime_dir(runtime_dir)?;
    rimz::disk::paths::ensure_private_runtime_dir(rimz_dir)?;
    rimz::disk::paths::ensure_private_runtime_dir(link_dir)?;
