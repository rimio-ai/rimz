...
| `src/sidebar_pane/` | native pane-resident sidebar process: the fixed-timestep serve loop and producer election (`app/`), terminal notification OSC/BEL emission (`osc.rs`), and frame composition over the snapshot view-model (`render/`) | [sidebar.md](./docs/internals/sidebar.md) · [notifications.md](./docs/internals/notifications.md) · [interface/sidebar.md](./docs/interface/sidebar.md) |
