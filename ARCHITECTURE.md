...
- `src/agents/` — the agent integration layer; conventions in its own [`AGENTS.md`](./crates/rimz/src/agents/AGENTS.md), the boundary model in [docs/internals/hooks.md](./docs/internals/hooks.md).
