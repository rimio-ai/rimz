...
- **Agent orchestration peers** — `message` (durable per-agent message queue and delivery pipeline; [message.md](./docs/internals/agents/message.md)), `remote_control` (agent remote-control launch).
