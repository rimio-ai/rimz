...
| `ledger/` | durable state: atomic helpers, framed event log and event envelope, feed store, message and run stores, `transcript_log.rs`, snapshot rebuild and staged view projection, wakeups, GC | [contract](./crates/rimz/src/ledger/AGENTS.md) · [ledger.md](./docs/internals/sidebar/ledger.md) |
