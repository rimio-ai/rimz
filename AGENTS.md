...
- **`harness/`** — [harness.md](./docs/internals/harness/harness.md) (subsystem overview, layout IR, exec wrapper, address grammar, resume, budget scopes, pane reclaim), [scripting.md](./docs/internals/harness/scripting.md) (supervised `-p` runs: record, wake socket, verify/retry, output), [loops.md](./docs/internals/harness/loops.md) (scheduled tasks: catalog, elder firing, fire gates, assist log), [messaging.md](./docs/internals/harness/messaging.md) (routing, records, delivery, reply waits, channels, transcript, asks), [worktrees.md](./docs/internals/harness/worktrees.md) (RimZ-owned Git worktrees), [trust.md](./docs/internals/harness/trust.md) (permission model: executable surface, grants, the stale diff).
