...
- `agents/` — the `AgentAdapter` trait, `state.rs` rollup, per-kind adapters (Claude, Codex, Amp, Copilot, Gemini, Pi, OpenCode, Cursor, Droid, Kiro), the shared `plugin/` process adapter, spend/pricing/account.
...
- [agent-support.md](./docs/reference/agent-support.md) — per-agent status, integration surface, and permission-mode mapping for Claude, Codex, Amp, Copilot, Gemini, Pi, OpenCode, Cursor, Droid, Kiro; [agent-plugins.md](./docs/reference/agent-plugins.md) — external bundle, canonical wire, and probe contracts.
...
- **`agents/`** — [model.md](./docs/internals/agents/model.md) (agent model: rollup, state machine, adapter boundary, live context), [plugin.md](./docs/internals/agents/plugin.md) (third-party process plugins), the per-kind mappings [claude.md](./docs/internals/agents/claude.md)/[codex.md](./docs/internals/agents/codex.md)/[amp.md](./docs/internals/agents/amp.md)/[copilot.md](./docs/internals/agents/copilot.md)/[gemini.md](./docs/internals/agents/gemini.md)/[pi.md](./docs/internals/agents/pi.md)/[opencode.md](./docs/internals/agents/opencode.md)/[cursor.md](./docs/internals/agents/cursor.md)/[droid.md](./docs/internals/agents/droid.md)/[kiro.md](./docs/internals/agents/kiro.md), [providers.md](./docs/internals/agents/providers.md) (accounts, balances, spend, pricing).
