...
- Two symbols carry every call for attention: `?` (*needs your answer*) and `!` (*needs a look*). The signal survives `NO_COLOR` and color-blindness; color is a second, redundant channel. Genuinely live work travels through spinner frames, and a needs-you or unread-result row breathes with a deeper pulse until you focus its pane; calm read rows hold still.
