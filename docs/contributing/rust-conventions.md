...
- `cargo nextest archive --workspace --all-features --locked --archive-file <path>` — compile and package workspace nextest binaries for archive-based test distribution.
