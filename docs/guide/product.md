...
Targets are agent kinds, session-id prefixes, or pane ids, with `--worktree` to narrow; the grammar and delivery gates live in [the agent-control reference](../reference/cli/agents.md#steer-a-live-agent).
