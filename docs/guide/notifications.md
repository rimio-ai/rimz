...
For Claude and Codex, [remote control](./agents.md#answer-asks-from-your-phone) closes the same loop through the provider's own app: the room starts the official mobile bridge on your opt-in, the ask pushes to your phone, and you answer the native prompt right there — no handler to write, no reattach.
