...
| `question.asked` | awaiting-user | `waiting` — RimZ records the joined question text; OpenCode's native question UI remains responsible for the answer |
