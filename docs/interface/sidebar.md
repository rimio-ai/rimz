...
|-------|-------|---------|-----------|
| `?`   | waiting    | the agent asked something; answer in its pane | yes — yellow, heating amber then red with the age clock; the breath quickens with it, blinking at red; unread rows hard-blink until focused |
