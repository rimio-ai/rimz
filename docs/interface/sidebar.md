...
| `◷` / `⌁`       | a wait entry's static violet lead: a timer or a signal; a running shell job (a PID, a watched command, or a background shell) wears the working animation in the same violet instead |
