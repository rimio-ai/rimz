...
| `⑃ N`           | open pull requests on agent lanes awaiting you — the glyph in the cool PR-open tone; click it to filter the body to those lanes |
