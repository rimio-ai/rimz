...
At narrow widths the card's waits count shortens to `⧖ N`, sharing its line with `⧉ N` when subagents are present. Expanded wait entries keep their elapsed clocks muted even for long waits.
