...
| `lsp` queries | `3` no server or stopped; `4` still indexing after the readiness wait; `5` name not found; `6` name ambiguous | [Shared language servers](./cli/lsp.md#exit-codes) |
