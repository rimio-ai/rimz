...
| **Run and steer agents** | `agents`, `subagents`, `teams`, `asks`, `answer`, `message`, `transcript`, `pane`, `events` | [Agents](./cli/agents.md) · [Subagents](./cli/subagents.md) · [Teams](./cli/teams.md) · [Asks](./cli/asks.md) · [Message](./cli/message.md) · [Transcript](./cli/transcript.md) · [Pane](./cli/pane.md) · [Events](./cli/events.md) |
