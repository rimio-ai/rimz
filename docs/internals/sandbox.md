...
Listing a skill never lifts a native user-only marker: listed skills bind their canonical sources without parsing their metadata, so an author's existing invocation restrictions still apply.
