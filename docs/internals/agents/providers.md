...
The per-kind surfaces each provider exposes are in the adapter docs ([claude.md](./claude.md#account-and-balance), [codex.md](./codex.md#account-and-balance), [amp.md](./amp.md#account-and-balance), [gemini.md](./gemini.md#account-and-balance), [copilot.md](./copilot.md#account-and-balance), [pi.md](./pi.md#account-and-balance), [opencode.md](./opencode.md#account-and-balance), [kiro.md](./kiro.md#transcript-lifecycle-and-context)); the raw auth and account-usage surfaces those read are in the per-provider upstream references ([claude-reference.md](../../externals/agent-adapter/claude-reference.md#auth-surface), [codex-reference.md](../../externals/agent-adapter/codex-reference.md#auth-file), [amp-reference.md](../../externals/agent-adapter/amp-reference.md#authentication-account-and-spend), [gemini-reference.md](../../externals/agent-adapter/gemini-reference.md#authentication-account-and-quota), [copilot-reference.md](../../externals/agent-adapter/copilot-reference.md#authentication-and-account-surface), [pi-reference.md](../../externals/agent-adapter/pi-reference.md#auth-file), [opencode-reference.md](../../externals/agent-adapter/opencode-reference.md#auth-file), [kiro-reference.md](../../externals/agent-adapter/kiro-reference.md#verified-stock-session-store)).
...
- **Cost source.** Claude, Codex, and Gemini log token counts, priced through the [token pricing](#token-pricing) table; Pi prefers its present non-negative direct cost and prices token-bearing rows where that field is absent; OpenCode uses positive stored `cost` values and prices zero-cost token rows ([claude.md → Cost](./claude.md#cost), [codex.md → Cost](./codex.md#cost), [gemini.md → Cost](./gemini.md#cost), [pi.md → Cost](./pi.md#cost), [opencode.md → Cost](./opencode.md#cost)).
