...
User setup lives in [theme.md Pets](../../guide/theme.md#pets). The config key appears in [configuration.md](../../reference/configuration.md#pets) because it is part of the generated theme template.
