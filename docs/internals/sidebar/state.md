...
| Provider-local sessions | producer data tick; write/wake only on a semantic observation or admitted-input change | Hookless identity binding without per-renderer provider-store scans |
