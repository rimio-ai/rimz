...
```
  ...
  ── assists (all) ───────────────────────────────────────────────────
  9 pings $0.09 · 2 redeems (2 resets) · 5 resumes +6.2h
  03:14 ▶ @coder resumed — limit park, 22:10→03:14 (5.1h recovered)
  03:12 ↻ codex credit — expiry rescue → budget reset ✓
  07:00 ⚡ codex ping — window 07:00→12:00
```
