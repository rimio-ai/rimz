...
```
  ...
  Sessions: 697            Spend: $103,540
  Active days: 27/28       Longest streak: 27 days
  Most active day: May 29  Current streak: 27 days

  Assists
  Auto-ping: 9 ($0.09)          Auto-continue: 5 (+6.2h)
  Auto-redeem: 2 (2 resets)     Focus repair: 3 (1 failed)
```
