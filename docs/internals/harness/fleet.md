...
| 2 | Sandbox view, or the host scratch line naming `$RIMZ_SCRATCH` ([sandbox.md](../sandbox.md#launch-reminder)) | the sandbox view under sandbox isolation with a successful bubblewrap preflight; the scratch line on every other launch |
