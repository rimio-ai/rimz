...
| `flip_compact` | `rimz teams flip` | flipper provider and session, role, previous and target stages, occupied context when known, effective threshold, durable compact-command message id, delivery verdict, and error when present |
