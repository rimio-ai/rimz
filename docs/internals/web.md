...
Appending the `rimzdebug=1` query parameter to the page URL exposes `window.__rimzWeb` with the live flow-control state and a 256-entry ring of recent mouse send decisions. Use [`scripts/web-drag-probe.mjs`](../../scripts/web-drag-probe.mjs) to measure this pipeline against a live browser room.
