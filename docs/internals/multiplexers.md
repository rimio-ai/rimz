...
The sidebar heartbeat socket is the wakeup channel of record. `zellij pipe --name rimz::feed` remains a best-effort broadcast optimization layered on top of socket wakeups; it never creates the sidebar and never gates correctness.
