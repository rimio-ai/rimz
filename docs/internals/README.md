...
| [claude.md](./agents/claude.md), [codex.md](./agents/codex.md), [gemini.md](./agents/gemini.md), [pi.md](./agents/pi.md), [opencode.md](./agents/opencode.md), [droid.md](./agents/droid.md) | Per-kind adapter mappings: how each native event, transcript, and account surface folds onto RimZ's types. |
