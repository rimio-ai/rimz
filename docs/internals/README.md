...
| [claude.md](./agents/claude.md), [codex.md](./agents/codex.md), [amp.md](./agents/amp.md), [gemini.md](./agents/gemini.md), [pi.md](./agents/pi.md), [opencode.md](./agents/opencode.md), [droid.md](./agents/droid.md), [kiro.md](./agents/kiro.md) | Per-kind adapter mappings: how each native event, transcript, and account surface folds onto RimZ's types. |
...
| [messaging.md](./harness/messaging.md) | Message routing: send modes, durable records, delivery, the channel lanes, and the transcript. |
