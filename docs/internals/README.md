...
| [subagents.md](./harness/subagents.md) | Agent-launched children: the agent-only launch and lifecycle verbs, the ancestry stamp and its depth cap, caller-scoped verbs, and the boundary with provider-native subagents. |
