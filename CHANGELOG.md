...
- Agent cards show cumulative estimated active time for root sessions, excluding waits, idle spans, parked background work, and silence past a configurable grace. → [sidebar](./docs/guide/sidebar.md#the-agent-card)
